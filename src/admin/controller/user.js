...
//指定需要查询的字段
const columns = ["id", "username", "gender", "birthday", "register_time", "last_login_time", "last_login_ip", "user_level_id", "nickname", "mobile", "register_ip", "avatar", "cash_paid", "is_distributor", "commision", "remainder", "distributor_level", "distributor_level_1", "referee", "balance", "cash", "cash_paid"];
