...
//指定需要查询的字段
const columns = ["id", "username", "gender", "birthday", "register_time", "last_login_time", "last_login_ip", "user_level_id", "nickname", "mobile", "register_ip", "avatar", "cash_paid", "is_distributor", "distributor_level", "referee", "balance", "cash", "cash_paid"];
