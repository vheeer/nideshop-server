...
module.exports = class extends Base {
  async loginByWeixinAction() {
    ...
    // 查询用户信息
    const newUserInfo = await this.model('user').field(['id', 'username', 'nickname', 'mobile', 'gender', 'avatar', 'birthday', 'referee', 'is_distributor', 'code', 'balance', 'cash_paid', 'distributor_level', 'commision']).where({ id: userId }).find();
