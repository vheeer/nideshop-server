...
module.exports = class extends Base {
  ...
  async postAction() {
    ...
    console.log([ typeId, valueId, content ]);
  ...
  async testAction() {
    ...
    let comments = [];
    console.log("-________________-the showType is:", showType);
    console.log("-________________-the typeof showType is:", typeof showType);
    if (showType != 1) {
      comments = await this.model('comment')
      .where({
        type_id: typeId,
        value_id: valueId
      })
